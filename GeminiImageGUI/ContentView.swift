...
struct ContentView: View {
    ...
    @State private var startPrompt: String = "1"
    @State private var endPrompt: String = ""
...
//                    .font(.headline)  // Slightly bolder for hierarchy
    ...
    private func asyncGenerate() async throws {
    ...
    private func handleBatchFileSelection(_ result: Result<[URL], Error>) {
        switch result {
        case .success(let urls):
            guard let url = urls.first else {
                errorMessage = "No file selected."
